...
\blockquote[Paraphrased from an interview with Nancy, owner of NOVA [Appendix~\ref{ch:client-meetings}]]{As NOVA is a
...
From the interview, as seen in Appendix~\ref{ch:client-meetings}, the authors chose to focus on two of the primary
